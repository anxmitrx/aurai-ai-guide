...
I want to, I want to make a website for, uh, uh, tournament, football tournament, Indian football tournament, not soccer tournament, uh, Indian football tournament. These are the animations I would like to provide. It should be aesthetic. Uh, the name of the tournament is Unity Cup. And, uh, the, the website should contain a homepage, a contact page, uh, photos, videos page, uh, a season page, like season one, season two, that is, uh, like the season page, and also, uhhh, an About page, where in, in the About page, uh, what is the tournament about, what is the tournament and, um, the organization, the organizing members, two of the members, uh, with their pic should show up if they click on the About page. Secondly, uh, I want this to be very aesthetic, like, and also incorporate the animations I have given you in the prompt o-over it, over this, uh, voice text. Also, I am, uh, planning to, uh, planning for a registered button here, like seas- uh, one, one-- there, there should be a CTA button of register now, uh, which would redirect to a page where their, uhhh, everything would be taken, where their name, uh, number, phone number, email ID would be taken, and the payment receipt would also be taken. Thank you.

This project was built with [Lovable](https://lovable.dev).

**Live app**: https://aurai-ai-guide.lovable.app

## Build with Lovable

Continue developing this project in the [Lovable editor](https://lovable.dev/projects/352ae6e9-578b-478c-92e3-3d954ea11cb4).
