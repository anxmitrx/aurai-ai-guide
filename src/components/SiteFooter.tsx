...
export function SiteFooter() {
  return (
    <footer className="mx-auto max-w-6xl border-t border-ink/10 pt-8 pb-6">
      <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
        <div className="flex items-center gap-2 text-ink">
          <UnityLogo className="h-5 w-5" />
          <span className="font-askan tracking-wide">Unity Cup</span>
        </div>
        <div className="flex flex-wrap items-center justify-center gap-5 text-xs text-ink/50">
          <Link to="/about" className="hover:text-ink">
            About
          </Link>
          <Link to="/seasons" className="hover:text-ink">
            Seasons
          </Link>
